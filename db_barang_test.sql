...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2022 at 08:03 AM
...
INSERT INTO `db_admin` (`id_admin`, `nama_admin`) VALUES
(11001, 'ADMIN');
...
INSERT INTO `db_barang` (`id_barang`, `id_korban`, `id_penemu`, `kd_hilang`, `kd_approve`, `nama_barang`, `kategori_barang`, `waktu_barang`, `lokasi_barang`, `deskripsi_barang`, `foto_barang`) VALUES
...
--
-- Table structure for table `db_korban`
--

CREATE TABLE `db_korban` (
...
--
-- Dumping data for table `db_korban`
--

INSERT INTO `db_korban` (`id_korban`, `id_user`, `nama_user`, `no_telepon`, `img`) VALUES
...
--
-- Table structure for table `db_penemu`
--

CREATE TABLE `db_penemu` (
...
--
-- Dumping data for table `db_penemu`
--

INSERT INTO `db_penemu` (`id_penemu`, `id_user`, `nama_user`, `no_telepon`, `img`) VALUES
...
--
-- Table structure for table `db_pengajuan_barang`
--

CREATE TABLE `db_pengajuan_barang` (
...
--
-- Dumping data for table `db_pengajuan_barang`
--

INSERT INTO `db_pengajuan_barang` (`id_pengajuan`, `id_barang`, `id_korban`, `id_penemu`, `konfirmasi_pengajuan`, `waktu_diajukan`) VALUES
...
--
-- Table structure for table `db_status_barang`
--

CREATE TABLE `db_status_barang` (
  `kd_status` varchar(10) NOT NULL,
  `keterangan_status` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `db_status_barang`
--

INSERT INTO `db_status_barang` (`kd_status`, `keterangan_status`) VALUES
...
INSERT INTO `db_user` (`user_id`, `user_name`, `user_email`, `user_password`, `user_no_telepon`, `user_created_at`, `user_instagram`, `user_facebook`, `user_alamat`, `user_role`, `user_img`) VALUES
...
--
-- Indexes for table `db_korban`
--
ALTER TABLE `db_korban`
  ADD PRIMARY KEY (`id_korban`),
  ADD KEY `id_user_in_korban` (`id_user`);

--
-- Indexes for table `db_penemu`
--
ALTER TABLE `db_penemu`
  ADD PRIMARY KEY (`id_penemu`),
  ADD KEY `id_user_in_tpenemu` (`id_user`);

--
-- Indexes for table `db_pengajuan_barang`
--
ALTER TABLE `db_pengajuan_barang`
...
--
-- Indexes for table `db_status_barang`
--
ALTER TABLE `db_status_barang`
...
--
ALTER TABLE `db_barang`
  ADD CONSTRAINT `id_korban_in_barang` FOREIGN KEY (`id_korban`) REFERENCES `db_korban` (`id_korban`) ON DELETE CASCADE,
  ADD CONSTRAINT `id_penemu_in_barang` FOREIGN KEY (`id_penemu`) REFERENCES `db_penemu` (`id_penemu`) ON DELETE CASCADE,
  ADD CONSTRAINT `kd_approve_in_barang` FOREIGN KEY (`kd_approve`) REFERENCES `db_status_barang` (`kd_status`),
  ADD CONSTRAINT `kd_hilang_in_barang` FOREIGN KEY (`kd_hilang`) REFERENCES `db_status_barang` (`kd_status`);

--
-- Constraints for table `db_korban`
--
ALTER TABLE `db_korban`
  ADD CONSTRAINT `id_user_in_korban` FOREIGN KEY (`id_user`) REFERENCES `db_user` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `db_penemu`
--
ALTER TABLE `db_penemu`
  ADD CONSTRAINT `id_user_in_tpenemu` FOREIGN KEY (`id_user`) REFERENCES `db_user` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `db_pengajuan_barang`
--
ALTER TABLE `db_pengajuan_barang`
  ADD CONSTRAINT `id_barang_in_pengajuan_barang` FOREIGN KEY (`id_barang`) REFERENCES `db_barang` (`id_barang`) ON DELETE CASCADE,
  ADD CONSTRAINT `id_korban_in_pengajuan_barang` FOREIGN KEY (`id_korban`) REFERENCES `db_korban` (`id_korban`),
  ADD CONSTRAINT `id_penemu_in_pengajuan_barang` FOREIGN KEY (`id_penemu`) REFERENCES `db_penemu` (`id_penemu`);
COMMIT;
